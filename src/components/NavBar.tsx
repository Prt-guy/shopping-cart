...
export default function NavBar() {
    ...
    const avaliableURLs = ['/', '/about', '/store']
    const isNavBarVisible = avaliableURLs.some((url) => url === currentPath);

    return (
        isNavBarVisible && (<Navbar className="bg-white shadow-sm mb-3 fs-5" sticky="top">
            <Container>
